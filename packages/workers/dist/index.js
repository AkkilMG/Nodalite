...
// src/pool.ts
import { Worker as Worker2, parentPort as workerThreadsParentPort } from "worker_threads";
...
var WorkerPool = class {
  ...
  closed = false;
  spawnWorker() {
    const worker = new Worker2(this.entryFile, { workerData: this.opts.workerData });
